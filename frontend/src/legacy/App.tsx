...
function QueueTab(p) {
  ...
  var staleQu = sortedQu.filter(function (r) {
  ...
  var bulkTargets = Object.keys(workflowGroups).filter(function (n) {
            ...
            h(
              ...
              diag.runner_groups && diag.runner_groups.length > 0
                ? h(
                    "div",
                    { style: { marginTop: 10 } },
                    diag.runner_groups.map(function (g, i) {
                ...
                ? h(
                    ...
                    h(
                      ...
                      h(
                        "tbody",
                        null,
                        (diag.sampled_jobs || []).map(function (j, i) {
                          var targetColor =
      ...
      qu.length > 0
        ? h(
            ...
            h(
              ...
              (staleQu.length > 0 ? staleQu : sortedQu).map(function (r) {
                var repo = (r.repository && r.repository.name) || "";
                var key = repo + "/" + r.id;
                var cstate = cancelling[key];
